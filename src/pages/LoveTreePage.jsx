  ...
  const handleUsePotion = async () => {
    try {
      ...
      if (res.success) {
        ...
        const newFloater = { id: Date.now(), diff: 50 };
...
// Custom Golden Coin Icon
const GoldenCoin = ({ size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
    <circle cx="16" cy="16" r="14" fill="url(#goldGrad)" stroke="#d97706" strokeWidth="1.5"/>
    <circle cx="16" cy="16" r="11" fill="none" stroke="#fef08a" strokeWidth="1" opacity="0.8"/>
    <text x="16" y="21.5" fontFamily="'Inter', sans-serif" fontSize="14" fontWeight="900" fill="#d97706" textAnchor="middle">X</text>
    <defs>
        ...
        rightContent={
          <div 
            ...
            style={{ 
              ...
              borderRadius: '24px',
              boxShadow: '0 4px 12px rgba(0,0,0,0.05), inset 0 1px 1px rgba(255,255,255,0.8)',
          ...
          >
            ...
            >
              ...
              <div className="guide-header">
                ...
                <div className="shop-balance-wrapper" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px', marginTop: '12px' }}>
                  <div className="shop-balance" style={{ margin: 0, padding: '8px 12px' }}>
                    ...
                    <div className="balance-item" title="Cọc chống cây">
                      <span className="material-symbols-outlined" style={{ fontSize: '18px', color: '#f59e0b' }}>fence</span> {tree?.treeProps || 0}
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="shop-items">
                <div className="shop-item">
                  ...
                  <button className="buy-btn" onClick={() => handleBuyItem('pesticide')} disabled={isBuying || tree?.coins < 200}>
                    200 Xu
                  </button>
                </div>
                ...
                <div className="shop-item">
                  ...
                  <button className="buy-btn" onClick={() => handleBuyItem('tree_prop')} disabled={isBuying || tree?.coins < 150}>
                    150 Xu
                  </button>
                </div>
                ...
                <div className="shop-item">
                  ...
                  <button className="buy-btn" onClick={() => handleBuyItem('fertilizer')} disabled={isBuying || tree?.coins < 200}>
                    200 Xu
                  </button>
                </div>
                ...
                <div className="shop-item">
                  ...
                  <button className="buy-btn" onClick={() => handleBuyItem('shield')} disabled={isBuying || tree?.coins < 1000}>
                    1000 Xu
                  </button>
                </div>
                ...
                <div className="shop-item">
                  ...
                  <button className="buy-btn" onClick={() => handleBuyItem('potion')} disabled={isBuying || tree?.coins < 250}>
                    250 Xu
                  </button>
                </div>
              </div>
