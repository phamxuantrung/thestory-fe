...
export const FOODS = [
  ...
  { id: "med_normal", name: "Thuốc Nhẹ", emoji: "💊", price: 8, fullness: 0, happiness: 0 },
  { id: "med_elixir", name: "Thần Dược", emoji: "💉", price: 50, fullness: 0, happiness: 0 },
];
...
export const PET_SKINS = [
  ...
  { id: "cat_cyberpunk", speciesId: "cat", name: "Mèo Cyberpunk", price: 120 },
  { id: "owl_pink", speciesId: "owl", name: "Cú Đêm Hoa Hồng", price: 100 },
  { id: "owl_galaxy", speciesId: "owl", name: "Cú Đêm Ngân Hà", price: 120 },
  { id: "fox_cyberpunk", speciesId: "fox", name: "Cáo Lửa Cyberpunk", price: 150 },
  { id: "fox_nature", speciesId: "fox", name: "Cáo Lửa Rừng Xanh", price: 120 },
  { id: "dragon_ice", speciesId: "dragon", name: "Rồng Con Băng Tuyết", price: 150 },
  { id: "dragon_nature", speciesId: "dragon", name: "Rồng Con Thiên Nhiên", price: 150 },
  { id: "dragon_sakura", speciesId: "dragon", name: "Rồng Con Anh Đào", price: 180 },
  { id: "phoenix_galaxy", speciesId: "phoenix", name: "Phượng Hoàng Vũ Trụ", price: 200 },
  { id: "wolf_nature", speciesId: "wolf", name: "Sói Trăng Rừng Thẳm", price: 150 },
  { id: "wolf_cyberpunk", speciesId: "wolf", name: "Sói Trăng Cyberpunk", price: 180 },
  { id: "turtle_mecha", speciesId: "turtle", name: "Rùa Ngọc Mecha", price: 150 },
  { id: "turtle_ocean", speciesId: "turtle", name: "Rùa Ngọc Biển Khơi", price: 180 },
  { id: "unicorn_nature", speciesId: "unicorn", name: "Kỳ Lân Mùa Xuân", price: 200 },
];
